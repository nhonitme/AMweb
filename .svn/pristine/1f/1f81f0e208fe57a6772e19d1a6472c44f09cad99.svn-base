...
function mergeInsertedRow(rows: InventoryOutputLine[], nextRow: InventoryOutputLine) {
    ...
    <div className="flex h-full min-h-0 flex-col gap-3">
      ...
      <div className="min-h-0 flex-1 overflow-hidden rounded-lg border border-gray-200 bg-white">
        ...
        >
          ...
          <Column dataField="OUTPUT_ID" caption={t("OUTPUT_ID", "Output ID")} visible={false} showInColumnChooser={false} allowHiding={false} />
          <Column dataField="OUTPUT_CD" caption={t("OUTPUT_CD", "Output Code")} visible={false} />
