              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-[11px] font-medium uppercase tracking-wide text-gray-500">
                    {t("DETAIL_LINE", "Detail Line")}
                  </div>
                  <div className="text-[11px] mt-1 font-semibold text-gray-800">
                    {detailLabel || "-"}
                  </div>
                </div>
                ...
                <div>
                  <div className="text-[11px] font-medium uppercase tracking-wide text-gray-500">
                    {t("DETAIL_ROW_AMOUNT", "Detail Amount")}
                  </div>
                ...
                <div>
                  <div className="text-[11px] font-medium uppercase tracking-wide text-gray-500">
                    {t("lblTotal_quantity", "Total Input Qty")}
                  </div>
                  <div className="mt-1 text-[11px] font-semibold text-gray-800">
                ...
                <div>
                  <div className="text-[11px] font-medium uppercase tracking-wide text-gray-500">
                    {t("TOTAL_AMOUNT", "Total Input Amount")}
                  </div>
                  <div className="mt-1 text-[11px] font-semibold text-gray-800">
